...
const DEFAULT_PRICING = {
  ...
  mainTitleHighlight: 'Plan',
  mainDescription:
    'Start free and scale as you grow. No hidden fees, no long-term contracts. Switch or cancel anytime with just one click.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 25%',
  plan1Name: 'Free',
  plan1Description: 'Perfect for trying out our platform',
  plan1Price: '$0',
  plan1CTA: 'Start Free',
  plan1CTAHref: '/',
  plan2Name: 'Pro',
  plan2Description: 'Everything you need to grow your business',
  plan2Price: '$19',
  plan2Period: '/month',
  ...
  plan3Name: 'Business',
  plan3Description: 'Advanced features for scaling teams',
  plan3Price: '$49',
  plan3Badge: 'Best Value',
  plan3CTA: 'Start Trial',
  plan3CTAHref: '/',
  bottomTitle: 'Questions about pricing?',
  bottomDescription:
    'Our team is here to help you find the right plan for your needs. Get personalized recommendations and answers to all your questions.',
